...
{   
    public class SalesReturnService : ISalesReturn
    {
        ...
        private void CreateAccountTransaction(CSalesReturn oSalesReturn, string billType)
        {
            ...
            //Finding bill amount          
            decimal billAmount = oSalesReturn.Details.Sum(e => ((e.Quantity * e.SalesReturnRate) - e.ProductDiscount) + (((e.Quantity * e.SalesReturnRate) - e.ProductDiscount) * e.Tax / 100)) + oSalesReturn.Expense;
        ...
        //Reports
        public List<CSalesReturnReportDetailed> FindSalesReturnDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string customerCode, string customer, string productCode, string product, decimal tax, string batch, DateTime expiryDate, string narration, string financialCode)
        {
        ...
        public List<CSalesReturnReportSummary> FindSalesReturnSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string customerCode, string customer, string productCode, string product, decimal tax, string batch, DateTime expiryDate, string narration, string financialCode)
        {
