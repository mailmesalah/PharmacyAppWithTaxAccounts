...
{   
    ...
    {        
        ...
        private void CreateAccountTransaction(CPurchase oPurchase, string billType)
        {
            ...
            //Finding bill amount
            decimal billAmount = oPurchase.Details.Sum(e => ((e.Quantity * e.PurchaseRate) - e.ProductDiscount) + (((e.Quantity * e.PurchaseRate) - e.ProductDiscount) * e.Tax / 100)) + oPurchase.Expense;
        ...
        //Reports
        public List<CPurchaseReportDetailed> FindPurchaseDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string supplierCode, string supplier, string productCode, string product, decimal tax, string batch, DateTime expiryDate, string narration, string financialCode)
        {
        ...
        public List<CPurchaseReportSummary> FindPurchaseSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string supplierCode, string supplier, string productCode, string product, decimal tax, string batch, DateTime expiryDate, string narration, string financialCode)
        {
