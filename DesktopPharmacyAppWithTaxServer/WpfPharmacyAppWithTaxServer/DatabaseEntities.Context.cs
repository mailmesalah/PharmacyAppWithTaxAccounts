...
namespace WpfServerApp
{
    ...
    public partial class Database9004Entities : DbContext
    {
        ...
        public virtual DbSet<barcode_print> barcode_print { get; set; }
        public virtual DbSet<barcode_property> barcode_property { get; set; }
        public virtual DbSet<barcode_data> barcode_data { get; set; }
    }
}
