...
namespace ServerServiceInterface
{
    ...
    public class CProduct
    {
        ...
        decimal purchaseInterstateTax;
        decimal purchaseWholesaleTax;
        decimal salesInterstateTax;
        decimal salesWholesaleTax;
        decimal salesLocalTax;
        ...
        [DataMember]
        public decimal PurchaseInterstateTax
        {
            get { return purchaseInterstateTax; }
            set { purchaseInterstateTax = value; }
        }
        [DataMember]
        public decimal PurchaseWholesaleTax
        {
            get { return purchaseWholesaleTax; }
            set { purchaseWholesaleTax = value; }
        }
        [DataMember]
        public decimal SalesInterstateTax
        {
            get { return salesInterstateTax; }
            set { salesInterstateTax = value; }
        }
        [DataMember]
        public decimal SalesWholesaleTax
        {
            get { return salesWholesaleTax; }
            set { salesWholesaleTax = value; }
        }
        [DataMember]
        public decimal SalesLocalTax
        {
            get { return salesLocalTax; }
            set { salesLocalTax = value; }
        }
    }
