...
{    
    ...
    public interface IPurchase
    {
        ...
        [OperationContract]
        List<CPurchaseReportSummary> FindPurchaseSummary(DateTime startDate, DateTime endDate, string billType, string billNo, string supplierCode, string supplier, string productCode, string product, decimal tax, string batch, DateTime expiryDate, string narration, string financialCode);
        [OperationContract]
        List<CPurchaseReportDetailed> FindPurchaseDetailed(DateTime startDate, DateTime endDate, string billType, string billNo, string supplierCode, string supplier, string productCode, string product, decimal tax, string batch, DateTime expiryDate, string narration, string financialCode);
