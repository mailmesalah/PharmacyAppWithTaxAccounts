...
namespace WpfClientApp.Registers
{
    ...
    public partial class ProductRegister : Window
    {
        ...
        {           
            ...
            mTextBoxPurchaseInterstateTax.Text = "";
            mTextBoxPurchaseWholesaleTax.Text = "";
            mTextBoxSalesInterstateTax.Text = "";
            mTextBoxSalesWholesaleTax.Text = "";
            mTextBoxSalesLocalTax.Text = "";
                ...
                if (l != null)
                {
                    using (ChannelFactory<IProduct> ProductProxy = new ChannelFactory<ServerServiceInterface.IProduct>("ProductEndpoint"))
                    {
                        ...
                        if (mCurrentProduct!= null)
                        {
                            ...
                            mTextBoxPurchaseInterstateTax.Text = mCurrentProduct.PurchaseInterstateTax.ToString("N2");
                            mTextBoxPurchaseWholesaleTax.Text = mCurrentProduct.PurchaseWholesaleTax.ToString("N2");
                            mTextBoxSalesInterstateTax.Text = mCurrentProduct.SalesInterstateTax.ToString("N2");
                            mTextBoxSalesWholesaleTax.Text = mCurrentProduct.SalesWholesaleTax.ToString("N2");
                            mTextBoxSalesLocalTax.Text = mCurrentProduct.SalesLocalTax.ToString("N2");
                        }
                    }
                }
            }
        ...
        private void saveDataToDatabase()
        {
            ...
            {                
                ...
                using (ChannelFactory<IProduct> ProductProxy = new ChannelFactory<ServerServiceInterface.IProduct>("ProductEndpoint"))
                {
                    ...
                    try
                    {
                        piTax = decimal.Parse(mTextBoxPurchaseInterstateTax.Text.Trim());
                    }
                    catch { }
                    ...
                    try
                    {
                        pwTax = decimal.Parse(mTextBoxPurchaseWholesaleTax.Text.Trim());
                    }
                    catch { }
                    ...
                    try
                    {
                        siTax = decimal.Parse(mTextBoxSalesInterstateTax.Text.Trim());
                    }
                    catch { }
                    ...
                    try
                    {
                        swTax = decimal.Parse(mTextBoxSalesWholesaleTax.Text.Trim());
                    }
                    catch { }
                    ...
                    try
                    {
                        slTax = decimal.Parse(mTextBoxSalesLocalTax.Text.Trim());
                    }
                    catch { }
                    ...
                    if(mProductType != "AGroup")
                    {
                        ...
                        ccr.PurchaseInterstateTax =  piTax;
                        ccr.PurchaseWholesaleTax = pwTax;
                        ccr.SalesInterstateTax = siTax;
                        ccr.SalesWholesaleTax = swTax;
                        ccr.SalesLocalTax = slTax;
                    }
                    else
                    {
                        ccr.StockInUnitCode = "";
                        ccr.StockOutUnitCode = "";
                        ccr.PurchaseInterstateTax = 0;
                        ccr.PurchaseWholesaleTax = 0;
                        ccr.SalesInterstateTax = 0;
                        ccr.SalesWholesaleTax = 0;
                        ccr.SalesLocalTax = 0;
                    }                    
