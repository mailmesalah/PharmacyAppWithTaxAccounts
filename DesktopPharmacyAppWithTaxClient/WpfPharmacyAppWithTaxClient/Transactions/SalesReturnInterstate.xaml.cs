...
namespace WpfClientApp.Transactions
{
    ...
    public partial class SalesReturnInterstate : Window
    {
        ...
        private void setGrandTotalnBalance()
        {
            ...
            try
            {
                gTotal = mGridContent.Sum(x => (((x.Quantity * x.SalesReturnRate) - x.ProductDiscount) * x.Tax / 100) + ((x.Quantity * x.SalesReturnRate) - x.ProductDiscount));
